...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div style="background-color:#0c1e0c" id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 ml-4 text-gray-800">Messages</h1>


                    <!-- DataTales Example -->
                    <div class="parent row">
                        <div class="header">
                            <!-- <button class="btn btn-primary">Delete All read message</button> -->
                        </div>
                ...
                <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div style="word-break:break-word" class="modal-body">

                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button class="confirm btn btn-secondary" type="button" name="button">confirm</button>
                        </div>
                    </div>
                </div>
                </div>
    ...
    <script src="ajax\users\contact.js"></script>
