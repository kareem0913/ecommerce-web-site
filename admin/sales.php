...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div style="background-color:#0c1e0c" id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 ml-4 text-gray-800">Sales</h1>
                ...
                <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="confirm-delete btn btn-secondary" type="button" name="button">confirm</button>
                        </div>
                    </div>
                </div>
                </div>
    ...
    <script src="ajax\users\sales.js"></script>
