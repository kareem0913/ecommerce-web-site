...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div style="background-color:#0c1e0c" id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 ml-4 text-gray-800">admins</h1>


                    <!-- DataTales Example -->
                    <button type="button" class="mb-3 ml-3 btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">
                        Add admin
                    </button>
                ...
                <!-- start modale add admin -->
                <div class="adduser modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <form>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="adress" value="" class="form-control" id="exampleInputEmail1" >
                                    <div class="err">
                                  ...
                                  <div class="form-group">
                                     ...
                                     <input type="text" name="age" value="" class="form-control" id="exampleInputEmail1" >
                                     <div class="err">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <input type="date" name="start_date" value="" class="form-control" id="exampleInputEmail1" >
                                      <div class="err">
                                ...
                                <input class="form-check-input" type="radio"  name="gander" id="inlineRadio1" value="0" >
                                <label class="form-check-label" for="inlineRadio1">Male</label>
                                </div>
                                <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gander" id="inlineRadio2" value="1" >
                ...
                <!-- start modale edit admin -->
                <div class="edituser modal fade" id="Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <br>
                                <div class="form-check form-check-inline">
                                <input class="male form-check-input" type="radio"  name="gander" id="inlineRadio1" value="0" >
                                <label class="form-check-label" for="inlineRadio1">Male</label>
                                </div>
                                <div class="form-check form-check-inline">
                                <input class="female form-check-input" type="radio" name="gander" id="inlineRadio2" value="1" >
                                <label class="form-check-label" for="inlineRadio2">Female</label>
                                <br>
                                <div class="err"></div>
                                </div>
    ...
    <script src="ajax/administration/admins.js"></script>
    <script src="ajax/administration/insert.js"></script>   <!-- insert new admin -->
    <script src="ajax/administration/update.js" charset="utf-8"></script>   <!-- update admin data -->
