...
<?php
   if (isset($_SESSION['cart'])) {
    ...
    <?php } ?>
<div style="background-color:rebeccapurple" class="wrap_header fixed-header2 trans-0-4">
    <!-- Logo -->
...
<header class="header2">
    <!-- Header desktop -->
    <div style="background-color:rebeccapurple" class="container-menu-header-v2 p-t-26">
        <div class="topbar2">
